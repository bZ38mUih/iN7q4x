...
$appRJ->response['result'].= "<!DOCTYPE html>".
    ...
    "<title>Категория, описаниие</title>".
...
$appRJ->response['result'].="<form class='newCateg' method='post'>".
    "<input type='hidden' name='flagField' value='editCatLongDescr'>".
"<div class='input-line ta-left'><label for='catIndex'>Длинное описание категории:</label></div>";
$appRJ->response['result'].="<textarea name='content'>".
    $Cat_rd->result['longDescr']."</textarea>".
